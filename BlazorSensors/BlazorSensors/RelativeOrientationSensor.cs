...
{
    public class RelativeOrientationSensor : ISensor
    {
        ...
        public RelativeOrientationSensor(IJSRuntime jSRuntime) => _jsRuntime = jSRuntime;

        public async Task Start()
        {
            await _jsRuntime.InvokeAsync<object>(
                "sensors.StartRelativeOrientationSensor",
        ...
        {
            await _jsRuntime.InvokeAsync<object>(
                "sensors.StopRelativeOrientationSensor");
            Activated = false;
        }
